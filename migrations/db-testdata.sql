...
INSERT INTO `cmg_core_permission` (`createdBy`,`modifiedBy`,`name`,`slug`,`type`,`icon`,`description`,`lValue`,`rValue`,`createdAt`,`modifiedAt`) VALUES 
	(1,1,'FoxSlider','foxslider','system',NULL,'The permission foxslider is to manage foxslider from admin.',1,2,'2014-10-11 14:22:54','2014-10-11 14:22:54');
...
UPDATE cmg_core_permission SET rootId=@permfxs where id=@permfxs;